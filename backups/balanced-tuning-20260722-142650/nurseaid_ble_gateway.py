...
# --- Protocol Timing ---
PHASE_1_DURATION = _env_int("PHASE_1_DURATION", 90)   # seconds for HR/Temp phase
PHASE_2_TIMEOUT = _env_int("PHASE_2_TIMEOUT", 75)     # seconds for SpO2 phase
...
class NurseAidBLEGateway:
        ...
        try:
            ...
            try:
                ...
                state["cooldown_until"] = max(
                    ...
                    time.time() + JSTYLE_ROTATION_COOLDOWN,
                )
    ...
    async def _phase1_hr_temp(self, client: BleakClient, mac: str, metadata: dict):
        ...
        print(f"[BLE] {mac}: Phase 1 — HR/Temp stream started")
