...
class MQTTBridgeWearStatusTest(unittest.TestCase):
    ...
    def test_off_wrist_payload_only_buffers_non_clinical_fields(self):
        self.send({
            "mac": self.MAC,
            "hr": 104,
            "spo2": 99,
        ...
        self.assertNotIn("ble/heart", mqtt_bridge.data_buffer)
        self.assertNotIn("ble/spo2", mqtt_bridge.data_buffer)
        self.assertNotIn("ble/temp", mqtt_bridge.data_buffer)
