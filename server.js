        ...
        window.addReceiverWifi = (mac, nodeId) => {
            ...
            openModal('เพิ่มเครือข่าย WiFi ให้ตัวรับสัญญาณ',
                '<div class="space-y-4">' +
                    ...
                    '</select></div>' +
                    '<div><label for="wifiSsid" class="block text-sm font-bold mb-2">ชื่อเครือข่าย (SSID)</label><input id="wifiSsid" maxlength="79" autocomplete="off" class="w-full border p-3 rounded-xl" style="background:var(--bg-input);color:var(--text-primary);" placeholder="เช่น hospital-wifi"></div>' +
